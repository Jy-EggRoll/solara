...
export const dom = {
    ...
    selectAllResultsItem: document.getElementById("selectAllResultsItem"),
    selectAllResultsItemLabel: document.getElementById("selectAllResultsItemLabel"),
    selectAllShortcutBadge: document.getElementById("selectAllShortcutBadge"),
